...
export const SignupPage = () => {
    ...
    return (
        ...
        className='max-w-md w-full bg-gray-800 bg-opacity-50 backdrop-filter backdrop-green-xl rounded-2xl shadow-xl
        overflow-hidden'>
        <div className='p-8'>
            ...
            <form onSubmit={handleSignup}>
                ...
                <Input
                icon={Mail} type="email" placeholder="Email Address" value={email}
                ...
                <motion.button className="mt-5 w-full py-3 px-4 bg-gradient-to-r from-green-500
